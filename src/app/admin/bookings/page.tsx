    ...
    <div className="max-w-5xl mx-auto w-full">
      ...
      <div className="flex flex-col gap-2.5 sm:flex-row sm:gap-3 mb-5">
        ...
        <select
          ...
          className="h-11 rounded-xl border border-input bg-white px-3 text-sm w-full sm:w-auto"
        >
          ...
          {filtered.map((b) => (
            ...
            >
              <button
                ...
                className="w-full flex items-start gap-3 p-4 text-left min-h-[72px] touch-manipulation active:bg-muted/30"
              >
                    ...
                    <div className="text-sm">
                      ...
                      {b.customer_phone && (
                        <a
                          ...
                          className="inline-flex items-center gap-1.5 text-primary text-xs mt-1 min-h-[44px]"
                        >
